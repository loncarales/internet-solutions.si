...
class Padd_Widget_Search_Form extends WP_Widget {

	function Padd_Widget_Custom_Ads() {
		$widget_ops = array(
						'classname' => 'box-search',
						'description' => PADD_THEME_NAME . ' Theme widget for custom search form.'
					);
		$this->WP_Widget(PADD_THEME_SLUG . '_search_form',PADD_THEME_NAME . ' Search Form', $widget_ops);
		$this->alt_option_name = PADD_THEME_SLUG .  '_widget_search_form';
	}
