 ...
 *
 * TODO Add headers and custom CSS styles
 * TODO Add menus? This would help to know if we're on a plugin page. 
 */
...
if (!class_exists('PageBuilder')) { class PageBuilder {
	 ...
	 * @param $errormsg If true, show an error message.
	 */
	 ...
	 */
	function showListOfErrors($errors)
	{
	 ...
	 */
	function showPageHeader($pagetitle, $width = "75%")
	{
		$this->paneOpen = false;
